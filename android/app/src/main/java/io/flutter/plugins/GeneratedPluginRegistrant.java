...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.neratech.mobile_number_picker.MobileNumberPickerPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin mobile_number_picker, com.neratech.mobile_number_picker.MobileNumberPickerPlugin", e);
    }
    try {
