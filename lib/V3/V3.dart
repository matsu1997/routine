...
import 'package:routine/V3/V3All.dart';
...
class _V3State extends State<V3> {
  ...
  //chat.png  coffee.png  education.png  food.png  imagin.png  love.png   meditation.png
  // money.png   nature.png  peaple.png   sleep.png  study.png  workout.png
  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Colors.white,
        appBar: AppBar(backgroundColor: Colors.white,
          ...
          actions: <Widget>[IconButton(onPressed: () { Navigator.of(context).push(MaterialPageRoute(builder: (context) => V3All()),).then((value) {});}, icon: Icon(Icons.search,size:30,color: Colors.green,))],
        ),
        floatingActionButton: FloatingActionButton(backgroundColor: Colors.orange,
          child: Icon(Icons.navigate_next), onPressed: () {next();},),
        body: SingleChildScrollView(
            child: Column(children: <Widget>[
              Container(margin:EdgeInsets.only(top:0,left: 50,right: 50),child:  Image.asset(image),),
              Container(margin:EdgeInsets.only(top:30,left: 20,right: 20),child: Text(item[count][1],style: TextStyle(fontWeight: FontWeight.bold,color:Colors.black,fontSize: 25),textAlign: TextAlign.center,),),
              Container(margin:EdgeInsets.only(top:30,bottom:60,left: 20,right: 20),child: Text(item[count][2],style: TextStyle(fontWeight: FontWeight.bold,color:Colors.blueGrey[200],fontSize: 15,height: 3),textAlign: TextAlign.center,),),
            ])));}
  void next (){setState(() { count = rand.nextInt(item.length);St = item[count][0]; image = item[count][0];});}
